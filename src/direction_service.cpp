...
// using RobotControlCustomMsg = custom_interfaces::srv::RobotControlCustomMsg;
...
//     srv_ = create_service<RobotControlCustomMsg>(
...
// private:
//   rclcpp::Service<RobotControlCustomMsg>::SharedPtr srv_;
//   rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr publisher_;

//   void moving_callback(
//       const std::shared_ptr<RobotControlCustomMsg::Request> request,
//       const std::shared_ptr<RobotControlCustomMsg::Response> response) {
